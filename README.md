...
Notes: All currencies must be entered using their corresponding 3 character code in UPPERCASE. Conversions to additional currencies can be made by passing additional arguments beyond those required above.
